...
public class Series2016Event1Scores extends CCSeries2016 {
	...
	private void checkSeriesAtEvent1(Scores scores) throws Exception {
		...
		race1AssertUtil.assertPilot(findPilot("IR077"), 5, 0, false, 7, 7); //$NON-NLS-1$
		race1AssertUtil.assertPilot(findPilot("IR023"), 4, 0, false, 8, 8); //$NON-NLS-1$
		race1AssertUtil.assertPilot(findPilot("IR016"), 0, 0, false, 10, 9); //$NON-NLS-1$
		...
		race2AssertUtil.assertPilot(findPilot("IR023"), 1, 0, false, 7, 7); //$NON-NLS-1$
		race2AssertUtil.assertPilot(findPilot("IR016"), 0, 0, false, 10, 8); //$NON-NLS-1$
		race2AssertUtil.assertPilot(findPilot("IR085"), 0, 0, false, 10, 8); //$NON-NLS-1$
		...
		race3AssertUtil.assertPilot(findPilot("IR085"), 2, 0, false, 7, 7); //$NON-NLS-1$
		race3AssertUtil.assertPilot(findPilot("IR016"), 1, 0, false, 8, 8); //$NON-NLS-1$
		race3AssertUtil.assertPilot(findPilot("IR023"), 0, 0, false, 10, 9); //$NON-NLS-1$
		...
		race4AssertUtil.assertPilot(findPilot("IR023"), 1, 0, false, 7, 7); //$NON-NLS-1$
		race4AssertUtil.assertPilot(findPilot("IR016"), 0, 0, false, 10, 8); //$NON-NLS-1$
		race4AssertUtil.assertPilot(findPilot("IR085"), 0, 0, false, 10, 8); //$NON-NLS-1$
		race4AssertUtil.assertDone(0);

		OverallAssertUtil overallAssertUtil = new OverallAssertUtil(scores);
		overallAssertUtil.assertPilot(findPilot("SCO116"), 0, 4, 1, 2); //$NON-NLS-1$
		overallAssertUtil.assertPilot(findPilot("IR021"), 0, 7, 2, 6); //$NON-NLS-1$
		overallAssertUtil.assertPilot(findPilot("SCO808"), 1, 7, 3, 6); //$NON-NLS-1$
		overallAssertUtil.assertPilot(findPilot("IR053"), 0, 7, 4, 4); //$NON-NLS-1$
		overallAssertUtil.assertPilot(findPilot("SCO159"), 0, 12, 5, 6); //$NON-NLS-1$
		overallAssertUtil.assertPilot(findPilot("IR077"), 0, 15, 6, 7); //$NON-NLS-1$
		overallAssertUtil.assertPilot(findPilot("IR085"), 0, 22, 7, 10); //$NON-NLS-1$
		overallAssertUtil.assertPilot(findPilot("IR023"), 0, 22, 8, 10); //$NON-NLS-1$
		overallAssertUtil.assertPilot(findPilot("IR016"), 0, 28, 9, 10); //$NON-NLS-1$
	...
	public final void checkRace1() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(findPilot("IR077"), 5, 0, false, 7, 7); //$NON-NLS-1$
			raceAssertUtil.assertPilot(findPilot("IR023"), 4, 0, false, 8, 8); //$NON-NLS-1$
			raceAssertUtil.assertPilot(findPilot("IR016"), 0, 0, false, 10, 9); //$NON-NLS-1$
			...
			overallAssertUtil.assertPilot(findPilot("IR077"), 0, 7, 7); //$NON-NLS-1$
			overallAssertUtil.assertPilot(findPilot("IR023"), 0, 8, 8); //$NON-NLS-1$
			overallAssertUtil.assertPilot(findPilot("IR016"), 0, 10, 9); //$NON-NLS-1$
			overallAssertUtil.assertOrder();
	...
	public final void checkRace2() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(findPilot("IR023"), 1, 0, false, 7, 7); //$NON-NLS-1$
			raceAssertUtil.assertPilot(findPilot("IR016"), 0, 0, false, 10, 8); //$NON-NLS-1$
			raceAssertUtil.assertPilot(findPilot("IR085"), 0, 0, false, 10, 8); //$NON-NLS-1$
			raceAssertUtil.assertDone(0);
			...
			overallAssertUtil.assertPilot(findPilot("IR023"), 0, 7, 7); //$NON-NLS-1$
			overallAssertUtil.assertPilot(findPilot("IR016"), 0, 10, 8); //$NON-NLS-1$
			overallAssertUtil.assertPilot(findPilot("IR085"), 0, 10, 8); //$NON-NLS-1$
			overallAssertUtil.assertOrder();
	...
	public final void checkRace3() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(findPilot("IR085"), 2, 0, false, 7, 7); //$NON-NLS-1$
			raceAssertUtil.assertPilot(findPilot("IR016"), 1, 0, false, 8, 8); //$NON-NLS-1$
			raceAssertUtil.assertPilot(findPilot("IR023"), 0, 0, false, 10, 9); //$NON-NLS-1$
			raceAssertUtil.assertDone(0);
			...
			overallAssertUtil.assertPilot(findPilot("IR085"), 0, 7, 7); //$NON-NLS-1$
			overallAssertUtil.assertPilot(findPilot("IR016"), 0, 8, 8); //$NON-NLS-1$
			overallAssertUtil.assertPilot(findPilot("IR023"), 0, 10, 9); //$NON-NLS-1$
			overallAssertUtil.assertOrder();
