...
public class ExportSPKASeries2013 {
	public static final File SERIES_FILE1 = new File("target/spka2013_1.xml"); //$NON-NLS-1$
	public static final File SERIES_FILE2 = new File("target/spka2013_2.xml"); //$NON-NLS-1$
