...
public class UKSeries2019 extends AbstractSPKASeries {
	...
	public void createDatabase() throws Exception {
		...
		addSeries();
		addPilot("SCO023@2005", MALE, "Scotland", "DP", "DP1", "DP2", "DP3", "DP4");
		...
		addPilot("K866@2019", MALE, "England");
	...
	protected void createEvent1Races() throws Exception {
		...
		addAttendees(1, 1, PILOT, "SCO023", "SCO045", "SCO066", "SCO116", "SCO156", "SCO179", "SCO808");
