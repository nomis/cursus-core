...
public class ExportCCSeries2014Top5 {
	public static final File SERIES_FILE1 = new File("target/cc2014top5_1.xml"); //$NON-NLS-1$
	public static final File SERIES_FILE2 = new File("target/cc2014top5_2.xml"); //$NON-NLS-1$
