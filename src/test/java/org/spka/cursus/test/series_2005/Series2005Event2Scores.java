...
public class Series2005Event2Scores extends Series2005Event1Scores {
	...
	private void checkSeriesAtEvent2(Scores scores) throws Exception {
		...
		overallAssertUtil.assertPilot(sco160, 0, 11, 2, 9);
		overallAssertUtil.assertPilot(sco081, 0, 22, 3, 12);
		overallAssertUtil.assertPilot(sco019, 0, 33, 4, 15);
		overallAssertUtil.assertPilot(sco154, 0, 35, 5, 17);
		overallAssertUtil.assertPilot(sco095, 0, 38, 6, 15);
		overallAssertUtil.assertPilot(sco020, 0, 40, 7, 17);
		overallAssertUtil.assertPilot(sco109, 0, 52, 8, 17);
		overallAssertUtil.assertPilot(sco158, 0, 54, 9, 15);
		overallAssertUtil.assertPilot(sco136, 0, 58, 10, 13);
		overallAssertUtil.assertPilot(sco117, 0, 61, 11, 17);
		overallAssertUtil.assertPilot(sco050, 0, 61, 12, 17);
		overallAssertUtil.assertPilot(sco159, 0, 66, 13, 17);
		overallAssertUtil.assertPilot(sco135, 0, 72, 14, 17);
		overallAssertUtil.assertPilot(sco060, 0, 76, 15, 17);
		overallAssertUtil.assertPilot(sco100, 0, 78, 16, 17);
		overallAssertUtil.assertPilot(sco071, 0, 85, 17, 17);
		overallAssertUtil.assertPilot(sco105, 0, 92, 18, 17);
		overallAssertUtil.assertPilot(sco143, 0, 102, 19, 17);
		overallAssertUtil.assertPilot(sco169, 0, 102, 19, 17);
		overallAssertUtil.assertPilot(sco178, 0, 102, 19, 17);
		overallAssertUtil.assertPilot(sco179, 0, 102, 19, 17);
