...
public class Series2013 extends AbstractSPKASeries {
	public Series2013() {
		super("SPKA Race Series 2013/14", SPKAConstants.UUID_2012); //$NON-NLS-1$
	}
	...
	protected void createSeriesData() throws Exception {
		...
		try {
			...
			sco066 = new Pilot(series, "SCO066@2013", Gender.MALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			sco066.getClasses().add(_16inWheel);
			series.getPilots().add(sco066);

			sco069 = new Pilot(series, "SCO069@2013", Gender.MALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			...
			sco116 = new Pilot(series, "SCO116@2010", Gender.MALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			...
			sco153 = new Pilot(series, "SCO153@2010", Gender.FEMALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			sco153.getClasses().add(_16inWheel);
			series.getPilots().add(sco153);

			sco156 = new Pilot(series, "SCO156@2010", Gender.MALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			...
			sco249 = new Pilot(series, "SCO249@2011", Gender.FEMALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			series.getPilots().add(sco249);

			sco296 = new Pilot(series, "SCO296@2013", Gender.FEMALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			sco296.getClasses().add(_16inWheel);
			series.getPilots().add(sco296);

			sco315 = new Pilot(series, "SCO315@2011", Gender.MALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			sco315.getClasses().add(_16inWheel);
			series.getPilots().add(sco315);

			sco528 = new Pilot(series, "SCO528@2011", Gender.MALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			series.getPilots().add(sco528);

			sco561 = new Pilot(series, "SCO561@2012", Gender.MALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
			series.getPilots().add(sco561);

			sco666 = new Pilot(series, "SCO666@2012", Gender.MALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	protected void createRace21Data() throws Exception {
		...
		try {
			...
			Race race21 = new Race(event6, RACE21_NAME, RACE21_DESC);
			event6.getRaces().add(race21);
			race21.getAttendees().put(sco069, new RaceAttendee(race21, sco069, RaceAttendee.Type.PILOT));
			...
			addLaps(race21, "116,69,808,666"); //$NON-NLS-1$
			addLaps(race21, "69,808,116,666"); //$NON-NLS-1$
			addLaps(race21, "69,116,808"); //$NON-NLS-1$
	...
	protected void createRace22Data() throws Exception {
		...
		try {
			...
			Race race22 = new Race(event6, RACE22_NAME, RACE22_DESC);
			event6.getRaces().add(race22);
			RaceAttendee att069 = new RaceAttendee(race22, sco069, RaceAttendee.Type.PILOT);
			att069.getPenalties().add(new Penalty(Penalty.Type.AUTOMATIC, "Priority at start")); //$NON-NLS-1$
			race22.getAttendees().put(sco069, att069);
			...
			RaceAttendee att666 = new RaceAttendee(race22, sco666, RaceAttendee.Type.PILOT);
			att666.getPenalties().add(new Penalty(Penalty.Type.AUTOMATIC, "Hit mark 1")); //$NON-NLS-1$
			race22.getAttendees().put(sco666, att666);
			...
			addLaps(race22, "116,808,666,69,528,179"); //$NON-NLS-1$
			addLaps(race22, "116,808,666,528,69,179"); //$NON-NLS-1$
			addLaps(race22, "116,666,808,528,69,179"); //$NON-NLS-1$
			addLaps(race22, "116,808,528,666,69"); //$NON-NLS-1$
			addLaps(race22, "116,808,528"); //$NON-NLS-1$
			addLaps(race22, "116"); //$NON-NLS-1$
