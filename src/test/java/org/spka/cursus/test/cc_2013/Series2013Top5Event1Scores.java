...
public class Series2013Top5Event1Scores extends AbstractSeries2013Top5 {
	...
	private void checkSeriesAtEvent1(Scores scores) throws Exception {
		...
		race6AssertUtil.assertDone(5);

		OverallAssertUtil overallAssertUtil = new OverallAssertUtil(scores);
		overallAssertUtil.assertPilot(ir181, 0, 2, 1);
		overallAssertUtil.assertPilot(ir001, 3, 18, 2);
		overallAssertUtil.assertPilot(sco116, 0, 24, 3);
		overallAssertUtil.assertPilot(sco808, 1, 28, 4);
		overallAssertUtil.assertPilot(sco528, 0, 29, 5);
		overallAssertUtil.assertPilot(ir014, 2, 26, 6);
		overallAssertUtil.assertPilot(sco159, 1, 36, 7);
		overallAssertUtil.assertPilot(ir025, 0, 33, 8);
		overallAssertUtil.assertPilot(ir085, 1, 34, 9);
		overallAssertUtil.assertPilot(ir016, 0, 7, 10);
		overallAssertUtil.assertPilot(sco666, 0, 41, 11);
		overallAssertUtil.assertPilot(ir077, 0, 17, 12);
		overallAssertUtil.assertPilot(ir053, 0, 27, 13);
		overallAssertUtil.assertPilot(sco153, 0, 10, 14);
		overallAssertUtil.assertPilot(sco060, 0, 0, 15);
	...
	public final void checkRace1() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir001, 6, 0, false, 3, 3);
			...
			raceAssertUtil.assertPilot(sco153, 4, 0, true, 0, 11);
			raceAssertUtil.assertPilot(ir077, 2, 0, true, 0, 12);
			raceAssertUtil.assertPilot(ir016, 2, 0, true, 0, 13);
			...
			overallAssertUtil.assertPilot(sco153, 0, 0, 11);
			overallAssertUtil.assertOrder();
	...
	public final void checkRace2() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir077, 4, 0, true, 0, 11);
			raceAssertUtil.assertPilot(ir016, 3, 0, true, 0, 12);
			raceAssertUtil.assertPilot(sco153, 2, 0, true, 0, 13);
	...
	public final void checkRace3() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir001, 5, 3, false, 2, 4);
			...
			raceAssertUtil.assertPilot(ir016, 3, 0, true, 0, 11);
			raceAssertUtil.assertPilot(ir077, 2, 0, true, 0, 12);
			raceAssertUtil.assertPilot(ir053, 2, 0, true, 0, 13);
			raceAssertUtil.assertPilot(sco153, 1, 0, true, 0, 14);
			raceAssertUtil.assertPilot(sco060, 0, 0, true, 0, 15);
			raceAssertUtil.assertDone(5);
			...
			overallAssertUtil.assertPilot(ir001, 3, 5, 4);
	...
	public final void checkRace4() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir001, 4, 0, false, 2, 2);
			...
			raceAssertUtil.assertPilot(sco666, 2, 0, false, 9, 9);
			raceAssertUtil.assertPilot(sco116, 1, 0, false, 10, 10);
			raceAssertUtil.assertPilot(ir014, 2, 0, true, 0, 11);
			raceAssertUtil.assertPilot(ir016, 2, 0, true, 0, 12);
			raceAssertUtil.assertPilot(ir053, 2, 0, true, 0, 13);
			raceAssertUtil.assertPilot(sco060, 0, 0, true, 0, 14);
			raceAssertUtil.assertPilot(sco153, 0, 0, true, 0, 14);
			raceAssertUtil.assertDone(5);
	...
	public final void checkRace5() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir053, 3, 0, true, 0, 11);
			raceAssertUtil.assertPilot(ir001, 1, 0, true, 0, 12);
			raceAssertUtil.assertPilot(ir016, 1, 0, true, 0, 13);
			raceAssertUtil.assertPilot(sco060, 0, 0, true, 0, 14);
			raceAssertUtil.assertPilot(sco153, 0, 0, true, 0, 14);
			raceAssertUtil.assertDone(5);
			...
			overallAssertUtil.assertPilot(ir001, 0, 0, 11);
			overallAssertUtil.assertPilot(ir016, 0, 0, 11);
			overallAssertUtil.assertPilot(ir053, 0, 0, 11);
			overallAssertUtil.assertPilot(sco060, 0, 0, 11);
			overallAssertUtil.assertPilot(sco153, 0, 0, 11);
	...
	public final void checkRace6() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir014, 6, 1, false, 3, 3);
			raceAssertUtil.assertPilot(sco528, 6, 0, false, 4, 4);
			raceAssertUtil.assertPilot(sco808, 6, 1, false, 5, 5);
			raceAssertUtil.assertPilot(ir001, 6, 0, false, 6, 6);
			...
			raceAssertUtil.assertPilot(sco153, 1, 0, false, 10, 10);
			raceAssertUtil.assertPilot(ir181, 3, 0, true, 0, 11);
			raceAssertUtil.assertPilot(ir085, 3, 0, true, 0, 12);
			raceAssertUtil.assertPilot(ir077, 2, 0, true, 0, 13);
			raceAssertUtil.assertPilot(sco060, 0, 0, true, 0, 14);
			raceAssertUtil.assertPilot(sco666, 0, 0, true, 0, 14);
			raceAssertUtil.assertDone(5);
			...
			overallAssertUtil.assertPilot(ir001, 0, 6, 6);
