...
import uk.uuid.cursus.xml.data.entity.DataXMLRace;
import uk.uuid.cursus.xml.data.entity.DataXMLRaceAttendee;
import uk.uuid.cursus.xml.data.entity.DataXMLRaceNumber;
import uk.uuid.cursus.xml.data.entity.DataXMLSeries;
import uk.uuid.cursus.xml.data.ref.DataXMLClassMember;
import uk.uuid.cursus.xml.data.ref.DataXMLClassRef;
import uk.uuid.cursus.xml.data.ref.DataXMLEventAttendee;
...
import uk.uuid.cursus.xml.scores.results.AbstractScoresXMLResults;
import uk.uuid.cursus.xml.scores.results.ScoresXMLEventRaceResults;
...
import uk.uuid.cursus.xml.scores.results.ScoresXMLSeriesEventResults;
