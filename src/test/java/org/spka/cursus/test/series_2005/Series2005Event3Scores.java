...
public class Series2005Event3Scores extends Series2005Event2Scores {
	...
	private void checkSeriesAtEvent3(Scores scores) throws Exception {
		...
		race5AssertUtil.assertPilot(sco019, 4, 0, false, 3, 3);
		race5AssertUtil.assertPilot(sco081, 3, 0, false, 4, 4);
		race5AssertUtil.assertPilot(sco109, 3, 0, false, 5, 5);
		race5AssertUtil.assertPilot(sco117, 3, 0, false, 6, 6);
		race5AssertUtil.assertPilot(sco154, 3, 0, false, 7, 7);
		race5AssertUtil.assertPilot(sco095, 3, 0, false, 8, 8);
		race5AssertUtil.assertPilot(sco100, 3, 0, false, 9, 9);
		race5AssertUtil.assertPilot(sco136, 3, 0, false, 10, 10);
		race5AssertUtil.assertPilot(sco071, 3, 0, false, 11, 11);
		race5AssertUtil.assertPilot(sco159, 3, 0, false, 12, 12);
		race5AssertUtil.assertPilot(sco158, 3, 0, false, 13, 13);
		race5AssertUtil.assertPilot(sco050, 2, 0, false, 14, 14);
		race5AssertUtil.assertPilot(sco135, 1, 0, false, 15, 15);
		race5AssertUtil.assertPilot(sco020, 0, 0, false, 17, 16);
		race5AssertUtil.assertPilot(sco060, 0, 0, false, 17, 16);
		race5AssertUtil.assertPilot(sco105, 0, 0, false, 17, 16);
		race5AssertUtil.assertPilot(sco143, 0, 0, false, 17, 16);
		race5AssertUtil.assertPilot(sco169, 0, 0, false, 17, 16);
		race5AssertUtil.assertPilot(sco178, 0, 0, false, 17, 16);
		race5AssertUtil.assertPilot(sco179, 0, 0, false, 17, 16);
		...
		race6AssertUtil.assertPilot(sco160, 8, 0, false, 2, 2);
		race6AssertUtil.assertPilot(sco081, 7, 0, false, 3, 3);
		race6AssertUtil.assertPilot(sco095, 7, 0, false, 4, 4);
		race6AssertUtil.assertPilot(sco019, 6, 0, false, 5, 5);
		race6AssertUtil.assertPilot(sco109, 6, 0, false, 6, 6);
		race6AssertUtil.assertPilot(sco071, 6, 0, false, 7, 7);
		race6AssertUtil.assertPilot(sco154, 6, 0, false, 8, 8);
		race6AssertUtil.assertPilot(sco135, 6, 0, false, 9, 9);
		race6AssertUtil.assertPilot(sco117, 6, 0, false, 10, 10);
		race6AssertUtil.assertPilot(sco100, 6, 0, false, 11, 11);
		race6AssertUtil.assertPilot(sco050, 6, 0, false, 12, 12);
		race6AssertUtil.assertPilot(sco136, 5, 0, false, 13, 13);
		race6AssertUtil.assertPilot(sco159, 5, 0, false, 14, 14);
		race6AssertUtil.assertPilot(sco158, 5, 0, false, 15, 15);
		race6AssertUtil.assertPilot(sco060, 4, 0, false, 16, 16);
		race6AssertUtil.assertPilot(sco020, 0, 0, false, 17, 17);
		race6AssertUtil.assertPilot(sco105, 0, 0, false, 17, 17);
		race6AssertUtil.assertPilot(sco143, 0, 0, false, 17, 17);
		race6AssertUtil.assertPilot(sco169, 0, 0, false, 17, 17);
		race6AssertUtil.assertPilot(sco178, 0, 0, false, 17, 17);
		race6AssertUtil.assertPilot(sco179, 0, 0, false, 17, 17);
		...
		race7AssertUtil.assertPilot(sco154, 5, 0, false, 4, 4);
		race7AssertUtil.assertPilot(sco158, 5, 0, false, 5, 5);
		race7AssertUtil.assertPilot(sco117, 4, 0, false, 6, 6);
		race7AssertUtil.assertPilot(sco100, 4, 0, false, 7, 7);
		race7AssertUtil.assertPilot(sco109, 4, 0, false, 8, 8);
		race7AssertUtil.assertPilot(sco019, 4, 0, false, 9, 9);
		race7AssertUtil.assertPilot(sco136, 3, 0, false, 10, 10);
		race7AssertUtil.assertPilot(sco159, 3, 0, false, 11, 11);
		race7AssertUtil.assertPilot(sco135, 2, 0, false, 12, 12);
		race7AssertUtil.assertPilot(sco060, 2, 0, false, 13, 13);
		race7AssertUtil.assertPilot(sco050, 2, 0, false, 14, 14);
		race7AssertUtil.assertPilot(sco095, 2, 0, false, 15, 15);
		race7AssertUtil.assertPilot(sco071, 1, 0, false, 16, 16);
		race7AssertUtil.assertPilot(sco020, 0, 0, false, 17, 17);
		race7AssertUtil.assertPilot(sco105, 0, 0, false, 17, 17);
		race7AssertUtil.assertPilot(sco143, 0, 0, false, 17, 17);
		race7AssertUtil.assertPilot(sco169, 0, 0, false, 17, 17);
		race7AssertUtil.assertPilot(sco178, 0, 0, false, 17, 17);
		race7AssertUtil.assertPilot(sco179, 0, 0, false, 17, 17);
		...
		overallAssertUtil.assertPilot(sco160, 0, 9, 2, 9, 4);
		overallAssertUtil.assertPilot(sco081, 0, 22, 3, 12, 9);
		overallAssertUtil.assertPilot(sco019, 0, 27, 4, 15, 9);
		overallAssertUtil.assertPilot(sco154, 0, 35, 5, 17, 8);
		overallAssertUtil.assertPilot(sco095, 0, 38, 6, 15, 14);
		overallAssertUtil.assertPilot(sco020, 0, 39, 7, 17, 17);
		overallAssertUtil.assertPilot(sco109, 0, 48, 8, 17, 14);
		overallAssertUtil.assertPilot(sco117, 0, 50, 9, 17, 17);
		overallAssertUtil.assertPilot(sco158, 0, 54, 10, 16, 15);
		overallAssertUtil.assertPilot(sco136, 0, 58, 11, 15, 13);
		overallAssertUtil.assertPilot(sco159, 0, 59, 12, 17, 14);
		overallAssertUtil.assertPilot(sco050, 0, 60, 13, 17, 14);
		overallAssertUtil.assertPilot(sco100, 0, 72, 14, 17, 17);
		overallAssertUtil.assertPilot(sco135, 0, 72, 15, 17, 16);
		overallAssertUtil.assertPilot(sco060, 0, 72, 16, 17, 16);
		overallAssertUtil.assertPilot(sco071, 0, 73, 17, 17, 17);
		overallAssertUtil.assertPilot(sco169, 0, 89, 18, 17, 17);
		overallAssertUtil.assertPilot(sco105, 0, 91, 19, 17, 17);
		overallAssertUtil.assertPilot(sco143, 0, 101, 20, 17, 17);
		overallAssertUtil.assertPilot(sco178, 0, 101, 20, 17, 17);
		overallAssertUtil.assertPilot(sco179, 0, 101, 20, 17, 17);
