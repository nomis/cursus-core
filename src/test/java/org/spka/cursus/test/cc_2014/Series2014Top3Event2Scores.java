...
public class Series2014Top3Event2Scores extends Series2014Top3Event1Scores {
	...
	private void checkSeriesAtEvent2(Scores scores) throws Exception {
		...
		overallAssertUtil.assertPilot(sco116, 0, 26, 5);
		overallAssertUtil.assertPilot(ir053, 0, 34, 6);
		overallAssertUtil.assertPilot(sco808, 0, 10, 7);
		overallAssertUtil.assertPilot(ir025, 0, 16, 8);
		overallAssertUtil.assertPilot(ir016, 0, 19, 9);
		overallAssertUtil.assertPilot(sco060, 0, 34, 10);
		overallAssertUtil.assertPilot(sco153, 0, 38, 11);
		overallAssertUtil.assertPilot(ir000, 0, 0, 12);
		overallAssertUtil.assertPilot(sco066, 0, 0, 12);
		overallAssertUtil.assertPilot(sco076, 0, 0, 12);
		overallAssertUtil.assertPilot(sco159, 0, 0, 12);
