...
public class Series2006Event4Scores extends Series2006Event3Scores {
	...
	private void checkSeriesAtEvent4(Scores scores) throws Exception {
		...
		race1AssertUtil.assertPilot(sco019, 0, 0, true, 5, 6);
		...
		race9AssertUtil.assertPilot(sco200, 6, 0, false, 5, 5);
		race9AssertUtil.assertPilot(sco019, 0, 0, true, 5, 6);
		...
		race9AssertUtil.assertPilot(sco205, 2, 0, false, 12, 13);
		race9AssertUtil.assertPilot(sco158, 0, 0, true, 12, 14);
		...
		race9AssertUtil.assertPilot(sco198, 0, 0, true, 17, 18);
		...
		race10AssertUtil.assertPilot(sco198, 0, 0, true, 17, 19);
		...
		race11AssertUtil.assertPilot(sco198, 0, 0, true, 17, 19);
		...
		overallAssertUtil.assertPilot(sco200, 0, 32, 2, 15, 11);
		overallAssertUtil.assertPilot(sco071, 0, 39, 3, 11, 7);
		overallAssertUtil.assertPilot(sco019, 0, 45, 4, 13, 12);
		overallAssertUtil.assertPilot(sco154, 0, 50, 5, 17, 15);
		overallAssertUtil.assertPilot(sco159, 0, 53, 6, 10, 10);
		overallAssertUtil.assertPilot(sco135, 0, 53, 7, 14, 10);
		overallAssertUtil.assertPilot(sco081, 0, 55, 8, 20, 20);
		overallAssertUtil.assertPilot(sco136, 0, 60, 9, 14, 10);
		overallAssertUtil.assertPilot(sco117, 0, 70, 10, 21, 13);
		overallAssertUtil.assertPilot(sco095, 0, 74, 11, 20, 12);
		overallAssertUtil.assertPilot(sco100, 0, 79, 12, 21, 13);
		overallAssertUtil.assertPilot(sco060, 0, 92, 13, 15, 13);
		overallAssertUtil.assertPilot(sco158, 0, 105, 14, 15, 15);
		overallAssertUtil.assertPilot(sco179, 0, 110, 15, 21, 18);
		overallAssertUtil.assertPilot(sco197, 0, 128, 16, 22, 21);
		overallAssertUtil.assertPilot(sco205, 0, 136, 17, 22, 21);
		overallAssertUtil.assertPilot(sco050, 0, 144, 18, 21, 20);
		overallAssertUtil.assertPilot(sco033, 0, 145, 19, 21, 18);
		overallAssertUtil.assertPilot(sco143, 0, 146, 20, 22, 21);
		overallAssertUtil.assertPilot(sco109, 0, 148, 21, 21, 20);
		overallAssertUtil.assertPilot(sco198, 0, 151, 22, 22, 21);
		overallAssertUtil.assertPilot(sco181, 0, 154, 23, 21, 20);
		overallAssertUtil.assertPilot(sco206, 0, 156, 24, 22, 20);
		overallAssertUtil.assertPilot(sco183, 0, 169, 25, 22, 21);
		overallAssertUtil.assertPilot(sco173, 0, 171, 26, 22, 21);
