...
public enum Namespace implements LSResourceResolver, LSInput {
	...
	DATA_V1 (XMLConstants.W3C_XML_SCHEMA_NS_URI, "urn:oid:1.3.6.1.4.1.39777.1.0.1.0.1", null, "uk/uuid/cursus/data-v1.xsd"), //$NON-NLS-1$ //$NON-NLS-2$

	RESULTS_V1 (XMLConstants.W3C_XML_SCHEMA_NS_URI, "urn:oid:1.3.6.1.4.1.39777.1.0.1.2.1", null, "uk/uuid/cursus/results-v1.xsd"), //$NON-NLS-1$ //$NON-NLS-2$

	SCORES_V1 (XMLConstants.W3C_XML_SCHEMA_NS_URI, "urn:oid:1.3.6.1.4.1.39777.1.0.1.1.1", null, "uk/uuid/cursus/scores-v1.xsd"); //$NON-NLS-1$ //$NON-NLS-2$
