...
public class CCSeries2015 extends AbstractSPKASeries {
	...
	protected static final int SERIES_FLEET_AT_EVENT1 = 8;

	protected static final String EVENT1_NAME = "Race Event 1"; //$NON-NLS-1$
	protected static final String EVENT1_DESC = "Luce Bay (20/06/2015)"; //$NON-NLS-1$
	...
	protected void createSeriesData() throws Exception {
		...
		try {
			...
			sco156 = new Pilot(series, "SCO156@2010", Sex.FEMALE, "Scotland"); //$NON-NLS-1$ //$NON-NLS-2$
