...
public class Series2014Event2Scores extends Series2014Event1Scores {
	...
	private void checkSeriesAtEvent2(Scores scores) throws Exception {
		...
		race1AssertUtil.assertPilot(ir181, 0, 0, false, 11, 10);
		race1AssertUtil.assertPilot(sco066, 0, 0, false, 11, 10);
		race1AssertUtil.assertPilot(sco076, 0, 0, false, 11, 10);
		race1AssertUtil.assertPilot(sco159, 0, 0, false, 11, 10);
		race1AssertUtil.assertPilot(sco808, 0, 0, false, 11, 10);
		...
		race2AssertUtil.assertPilot(ir181, 0, 0, false, 11, 10);
		race2AssertUtil.assertPilot(sco066, 0, 0, false, 11, 10);
		race2AssertUtil.assertPilot(sco076, 0, 0, false, 11, 10);
		race2AssertUtil.assertPilot(sco159, 0, 0, false, 11, 10);
		race2AssertUtil.assertPilot(sco808, 0, 0, false, 11, 10);
		...
		race3AssertUtil.assertPilot(ir181, 0, 0, false, 11, 10);
		race3AssertUtil.assertPilot(sco066, 0, 0, false, 11, 10);
		race3AssertUtil.assertPilot(sco076, 0, 0, false, 11, 10);
		race3AssertUtil.assertPilot(sco159, 0, 0, false, 11, 10);
		race3AssertUtil.assertPilot(sco808, 0, 0, false, 11, 10);
		...
		race4AssertUtil.assertPilot(ir181, 0, 0, false, 11, 10);
		race4AssertUtil.assertPilot(sco066, 0, 0, false, 11, 10);
		race4AssertUtil.assertPilot(sco076, 0, 0, false, 11, 10);
		race4AssertUtil.assertPilot(sco159, 0, 0, false, 11, 10);
		race4AssertUtil.assertPilot(sco808, 0, 0, false, 11, 10);
		...
		race5AssertUtil.assertPilot(ir181, 0, 0, false, 11, 10);
		race5AssertUtil.assertPilot(sco066, 0, 0, false, 11, 10);
		race5AssertUtil.assertPilot(sco076, 0, 0, false, 11, 10);
		race5AssertUtil.assertPilot(sco159, 0, 0, false, 11, 10);
		race5AssertUtil.assertPilot(sco808, 0, 0, false, 11, 10);
		...
		race6AssertUtil.assertPilot(sco159, 7, 0, false, 6, 6);
		race6AssertUtil.assertPilot(ir053, 5, 0, false, 7, 7);
		race6AssertUtil.assertPilot(ir000, 0, 0, false, 10, 8);
		race6AssertUtil.assertPilot(ir014, 0, 0, false, 10, 8);
		race6AssertUtil.assertPilot(ir016, 0, 0, false, 10, 8);
		race6AssertUtil.assertPilot(ir025, 0, 0, false, 10, 8);
		race6AssertUtil.assertPilot(sco060, 0, 0, false, 10, 8);
		race6AssertUtil.assertPilot(sco066, 0, 0, false, 10, 8);
		race6AssertUtil.assertPilot(sco076, 0, 0, false, 10, 8);
		race6AssertUtil.assertPilot(sco153, 0, 0, false, 10, 8);
		...
		race7AssertUtil.assertPilot(sco159, 7, 0, false, 6, 6);
		race7AssertUtil.assertPilot(ir053, 7, 0, false, 7, 7);
		race7AssertUtil.assertPilot(sco076, 3, 0, false, 8, 8);
		race7AssertUtil.assertPilot(ir000, 0, 0, false, 10, 9);
		race7AssertUtil.assertPilot(ir014, 0, 0, false, 10, 9);
		race7AssertUtil.assertPilot(ir016, 0, 0, false, 10, 9);
		race7AssertUtil.assertPilot(ir025, 0, 0, false, 10, 9);
		race7AssertUtil.assertPilot(sco060, 0, 0, false, 10, 9);
		race7AssertUtil.assertPilot(sco066, 0, 0, false, 10, 9);
		race7AssertUtil.assertPilot(sco153, 0, 0, false, 10, 9);
		race7AssertUtil.assertDone(0);

		OverallAssertUtil overallAssertUtil = new OverallAssertUtil(scores);
		overallAssertUtil.assertPilot(ir027, 0, 6, 1, 4);
		overallAssertUtil.assertPilot(sco179, 0, 13, 2, 4);
		overallAssertUtil.assertPilot(sco116, 0, 18, 3, 9);
		overallAssertUtil.assertPilot(ir014, 0, 27, 4, 11);
		overallAssertUtil.assertPilot(ir053, 0, 29, 5, 7);
		overallAssertUtil.assertPilot(ir025, 0, 43, 6, 10);
		overallAssertUtil.assertPilot(ir016, 0, 45, 7, 11);
		overallAssertUtil.assertPilot(sco060, 0, 46, 8, 10);
		overallAssertUtil.assertPilot(ir181, 0, 48, 9, 11);
		overallAssertUtil.assertPilot(sco153, 0, 52, 10, 10);
		overallAssertUtil.assertPilot(sco808, 0, 54, 11, 11);
		overallAssertUtil.assertPilot(sco159, 0, 56, 12, 11);
		overallAssertUtil.assertPilot(ir000, 0, 57, 13, 11);
		overallAssertUtil.assertPilot(sco076, 0, 62, 14, 11);
		overallAssertUtil.assertPilot(sco066, 0, 64, 15, 11);
	...
	public final void checkEvent2() throws Exception {
		...
		try {
			...
			overallAssertUtil.assertPilot(sco159, 0, 12, 6);
			overallAssertUtil.assertPilot(ir053, 0, 14, 7);
			overallAssertUtil.assertPilot(sco076, 0, 18, 8);
			overallAssertUtil.assertPilot(sco066, 0, 20, 9);
			overallAssertUtil.assertOrder();
	...
	public final void checkRace6() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir053, 5, 0, false, 7, 7);
			raceAssertUtil.assertPilot(sco066, 0, 0, false, 10, 8);
			raceAssertUtil.assertPilot(sco076, 0, 0, false, 10, 8);
			...
			overallAssertUtil.assertPilot(sco066, 0, 10, 8);
			overallAssertUtil.assertPilot(sco076, 0, 10, 8);
			overallAssertUtil.assertOrder();
	...
	public final void checkRace7() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco159, 7, 0, false, 6, 6);
			raceAssertUtil.assertPilot(ir053, 7, 0, false, 7, 7);
			raceAssertUtil.assertPilot(sco076, 3, 0, false, 8, 8);
