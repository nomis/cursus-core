...
@ScoringSystem(uuid = CCConstants.UUID_2009, name = CCConstants.NAME_2009)
public class CCScorer2009 extends AbstractScorer {
	@Override
	public Scores scoreRaces(List<Race> races, Set<Pilot> pilots, Set<Event> events, Predicate<Pilot> fleetFilter) {
		return new CCScoresFactory2009().newScores(pilots, races, events, fleetFilter, this);
	}
}