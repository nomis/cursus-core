 ...
 */
public class Series2013Top5Event1Scores extends CCSeries2013 {
	public Series2013Top5Event1Scores() {
		super(true);
	}
	...
	private void checkSeriesAtEvent1(Scores scores) throws Exception {
		...
		race5AssertUtil.assertPilot(ir027, 1, 0, true, 0, 12);
		...
		overallAssertUtil.assertPilot(ir027, 3, 18, 2);
	...
	public final void checkRace5() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir027, 1, 0, true, 0, 12);
			...
			overallAssertUtil.assertPilot(ir016, 0, 0, 11);
			overallAssertUtil.assertPilot(ir027, 0, 0, 11);
			overallAssertUtil.assertPilot(ir053, 0, 0, 11);
			overallAssertUtil.assertPilot(sco060, 0, 0, 11);
			overallAssertUtil.assertPilot(sco153, 0, 0, 11);
			overallAssertUtil.assertOrder();
