 ...
 */
public class Series2015Event1Scores extends CCSeries2015 {
	public Series2015Event1Scores() {
		super(false);
	}
	...
	private void checkSeriesAtEvent1(Scores scores) throws Exception {
		...
		race1AssertUtil.assertPilot(sco087, 1, 0, false, 6, 6);
		race1AssertUtil.assertPilot(sco156, 1, 0, false, 7, 7);
		race1AssertUtil.assertPilot(ir016, 0, 0, false, 10, 8);
		race1AssertUtil.assertPilot(sco066, 0, 0, false, 10, 8);
		...
		race2AssertUtil.assertPilot(sco159, 1, 2, false, 5, 5);
		race2AssertUtil.assertPilot(ir016, 0, 0, false, 10, 6);
		race2AssertUtil.assertPilot(sco066, 0, 0, false, 10, 6);
		race2AssertUtil.assertPilot(sco087, 0, 0, false, 10, 6);
		race2AssertUtil.assertPilot(sco156, 0, 0, false, 10, 6);
		...
		race3AssertUtil.assertPilot(sco159, 4, 0, false, 7, 7);
		race3AssertUtil.assertPilot(sco066, 4, 0, false, 8, 8);
		race3AssertUtil.assertPilot(ir016, 1, 0, false, 9, 9);
		...
		race4AssertUtil.assertPilot(sco156, 4, 0, false, 6, 6);
		race4AssertUtil.assertPilot(sco159, 3, 0, false, 7, 7);
		race4AssertUtil.assertPilot(ir016, 3, 0, false, 8, 8);
		race4AssertUtil.assertPilot(sco066, 0, 0, false, 10, 9);
		race4AssertUtil.assertDone(0);

		OverallAssertUtil overallAssertUtil = new OverallAssertUtil(scores);
		overallAssertUtil.assertPilot(ir181, 1, 1, 1, 0);
		overallAssertUtil.assertPilot(ir027, 0, 7, 2, 5);
		overallAssertUtil.assertPilot(sco808, 0, 7, 2, 4);
		overallAssertUtil.assertPilot(sco116, 0, 11, 4, 4);
		overallAssertUtil.assertPilot(sco159, 3, 18, 5, 7);
		overallAssertUtil.assertPilot(sco087, 1, 18, 6, 10);
		overallAssertUtil.assertPilot(sco156, 0, 18, 7, 10);
		overallAssertUtil.assertPilot(ir016, 0, 27, 8, 10);
		overallAssertUtil.assertPilot(sco066, 0, 28, 9, 10);
	...
	public final void checkRace1() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco087, 1, 0, false, 6, 6);
			raceAssertUtil.assertPilot(sco156, 1, 0, false, 7, 7);
	...
	public final void checkRace2() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(sco159, 1, 2, false, 5, 5);
			raceAssertUtil.assertPilot(ir016, 0, 0, false, 10, 6);
			raceAssertUtil.assertPilot(sco087, 0, 0, false, 10, 6);
			raceAssertUtil.assertPilot(sco156, 0, 0, false, 10, 6);
			raceAssertUtil.assertDone(0);
			...
			overallAssertUtil.assertPilot(sco116, 0, 4, 4);
			overallAssertUtil.assertPilot(sco159, 2, 7, 5);
			overallAssertUtil.assertPilot(ir016, 0, 10, 6);
			overallAssertUtil.assertPilot(sco087, 0, 10, 6);
			overallAssertUtil.assertPilot(sco156, 0, 10, 6);
			overallAssertUtil.assertOrder();
	...
	public final void checkRace3() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir016, 1, 0, false, 9, 9);
			raceAssertUtil.assertDone(0);
	...
	public final void checkRace4() throws Exception {
		...
		try {
			...
			raceAssertUtil.assertPilot(ir016, 3, 0, false, 8, 8);
